...
public class BaseCSize<CSIZE extends BaseCSize<CSIZE, CTYPE>, CTYPE extends Component> {
	...
	/**
	 * This method must be overriden by any extending-class to return 
	 * a CSIZE type of the extended class. 
	 */
	...
	public Dimension prefButton() { return dim(hvsize.getButtonWidth(), hvsize.getLineHeight()); }
	/** Dimension with line-width and line-height. */
	public Dimension prefLine() { return dim(hvsize.getLineWidth(), hvsize.getLineHeight()); }
	...
	public Dimension dimMax() { return dim(HVSize.MAX_WIDTH, HVSize.MAX_HEIGHT); }
